...
metres_label.grid(column=1, row=1, sticky="W", padx=5, pady=5)
metres_input = ttk.Entry(main, width=10, textvariable=metres_value)
metres_input.grid(column=2, row=1, sticky="EW", padx=5, pady=5)
metres_input.focus()

feet_label = ttk.Label(main, text="feet")
feet_label.grid(column=1, row=2, sticky="W", padx=5, pady=5)
feet_display = ttk.Label(main, textvariable=feet_value)
feet_display.grid(column=2, row=2, sticky="EW", padx=5, pady=5)

calc_button = ttk.Button(main, text="Calculate", command=calculate_feet)
calc_button.grid(column=1, row=3, columnspan=2, sticky="EW", padx=5, pady=5)
